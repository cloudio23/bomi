...
import { upsertPushSubscription, ensureDefaultCheckinSettings } from '../lib/supabaseAdmin.mjs';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // 알림을 처음 켤 때 기본 시간표(10/17/19/20시)로 건강 안부 문자 설정을
    // 미리 만들어둠 — 회원이 따로 설정에 들어가지 않아도 바로 동작하게.
